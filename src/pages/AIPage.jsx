    ...
    <>
      ...
      {summary && (
        <div className="mt-8 animate-fade-in">
          ...
          <div ref={summaryRef} className="p-6 bg-surface-100 rounded-lg shadow-md"><div className="prose-estudia max-w-none" dangerouslySetInnerHTML={{ __html: marked.parse(summary) }} /></div>
        </div>
      )}
