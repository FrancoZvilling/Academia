                ...
                <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                    ...
                    <form onSubmit={handleSubmit(onSubmitProfile)} className="space-y-4">
                        <div>
                            ...
                            <input {...register('displayName', { required: true })} className="input input-bordered border-black bg-surface-100 w-full dark:bg-gray-700 text-gray-700 dark:text-gray-300" />
                        </div>
                        <div>
                            <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Email (no se puede cambiar)</label>
                            <input type="email" value={currentUser?.email} disabled className="input input-bordered border-black bg-surface-100 w-full dark:bg-gray-700 text-gray-700 dark:text-gray-300" />
                        </div>
                        <div>
                    ...
                    <div className="bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
                        ...
                        <form onSubmit={handleSubmit(onSubmitPassword)} className="space-y-4">
                            <div>
                                ...
                                <input type="password" {...register('oldPassword')} className="input input-bordered border-black bg-surface-100 w-full dark:bg-gray-700 text-gray-700 dark:text-gray-300" />
                            </div>
                            <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Nueva Contraseña</label>
                                <input type="password" {...register('newPassword', { minLength: 6 })} className="input input-bordered border-black bg-surface-100 w-full dark:bg-gray-700 text-gray-700 dark:text-gray-300" />
                            </div>
                             <div>
                                <label className="block text-sm font-medium text-gray-700 dark:text-gray-300">Confirmar Nueva Contraseña</label>
                                <input type="password" {...register('confirmPassword')} className="input input-bordered border-black bg-surface-100 w-full dark:bg-gray-700 text-gray-700 dark:text-gray-300" />
                            </div>
