...
const SubjectForm = ({ onSubmit, onCancel, defaultValues = {}, isEditing = false }) => {
    ...
    return (
        <form onSubmit={handleSubmit(handleFormSubmit)} className="p-1 flex flex-col gap-4">
            <input {...register("name", { required: true })} placeholder="* Nombre de la materia" className="input input-bordered border-black bg-surface-100 w-full dark:bg-gray-700 text-gray-700 dark:text-gray-300" />
            <input {...register("professor")} placeholder="Profesor" className="input input-bordered border-black bg-surface-100 w-full dark:bg-gray-700 text-gray-700 dark:text-gray-300" />
            <div className="flex gap-4">
                <div className="w-1/2">
                    <input {...register("classroom")} placeholder="Aula (ej: 204)" className="input input-bordered border-black bg-surface-100 w-full dark:bg-gray-700 text-gray-700 dark:text-gray-300" />
                </div>
                <div className="w-1/2">
                    <input {...register("commission")} placeholder="Comisión (ej: 1K1)" className="input input-bordered border-black bg-surface-100 w-full dark:bg-gray-700 text-gray-700 dark:text-gray-300" />
                </div>
            </div>
...
const AddEventForm = ({ subject, onEventAdded }) => {
    ...
    return (
        <form onSubmit={handleSubmit(handleFormSubmit)} className="space-y-3 p-2">
            ...
            <div>
                <input {...register("title", { required: "El título es obligatorio" })} placeholder="Título (ej: Parcial)" className="input input-bordered border-black bg-surface-100 w-full dark:bg-gray-700 text-gray-700 dark:text-gray-300" />
